...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(428, 327)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.btnHobilerSecilenleriAl = QtWidgets.QPushButton(self.centralwidget)
        self.btnHobilerSecilenleriAl.setGeometry(QtCore.QRect(68, 183, 122, 27))
        ...
        self.lblResultHobiler.setGeometry(QtCore.QRect(68, 222, 118, 62))
        self.lblResultHobiler.setTextFormat(QtCore.Qt.PlainText)
        self.lblResultHobiler.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.lblResultHobiler.setObjectName("lblResultHobiler")
        self.groupHobiler = QtWidgets.QGroupBox(self.centralwidget)
        self.groupHobiler.setGeometry(QtCore.QRect(52, 8, 147, 167))
        self.groupHobiler.setObjectName("groupHobiler")
        self.widget = QtWidgets.QWidget(self.groupHobiler)
        self.widget.setGeometry(QtCore.QRect(12, 37, 122, 91))
        ...
        self.groupDersler.setGeometry(QtCore.QRect(231, 7, 158, 167))
        self.groupDersler.setObjectName("groupDersler")
        self.layoutWidget = QtWidgets.QWidget(self.groupDersler)
        self.layoutWidget.setGeometry(QtCore.QRect(12, 37, 132, 91))
        ...
        self.btnDerslerSecilenleriAl.setGeometry(QtCore.QRect(247, 183, 122, 27))
        ...
        self.lblResultDersler.setGeometry(QtCore.QRect(247, 219, 124, 62))
        self.lblResultDersler.setTextFormat(QtCore.Qt.PlainText)
        self.lblResultDersler.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblResultHobiler.setText(_translate("MainWindow", "Boş.."))
        self.groupHobiler.setTitle(_translate("MainWindow", "GroupHobiler"))
        ...
        self.groupDersler.setTitle(_translate("MainWindow", "GroupDersler"))
        ...
        self.lblResultDersler.setText(_translate("MainWindow", "Boş.."))
